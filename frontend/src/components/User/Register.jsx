...
const Register = () => {
    ...
    function connectWallet() {
        console.log("chal gya bhau", window.ethereum,account)
		window.ethereum
			.request({
				method: "eth_requestAccounts",
			})
			.then((accounts) => {
                setUserMetwallet(accounts[0])
    ...
    const { name, email, gender, password, cpassword, metawallet } = user;
    ...
    const handleRegister = (e) => {
        ...
        formData.set("metawallet", userMetwallet)
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                {account ? <span  className="text-white py-3 w-full bg-primary-orange shadow hover:shadow-lg rounded-sm font-medium text-center">Connected</span>:null}
                                {!account ? <button className="text-white py-3 w-full bg-primary-orange shadow hover:shadow-lg rounded-sm font-medium" onClick={connectWallet}>accountFetch MetaWallet</button>:null }
