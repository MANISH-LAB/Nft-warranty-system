                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        ...
                                        <span>{product.warranty} Days Warranty <Link className="font-medium text-primary-blue" to="/">Know More</Link></span>
                                    </div>
                                    {/* <!-- warranty & brand --> */}
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-blue"><VerifiedUserIcon sx={{ fontSize: "18px" }} /></span> {product.warranty} DAYS</p>
                                                </li>
                                                <li>
